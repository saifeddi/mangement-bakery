...
<div class="row pb-4 gy-3">
    <div class="col-sm-4">
        <a href="{{route('client.index')}}" class="btn btn-warning addtax-modal"><i class="las la-times me-1"></i> cancel</a>
    </div>
                ...
                <div class="p-2">
                    ...
                    <form action="{{ route('client.store') }}" method="POST">
                                ...
                                <div class="col-md-6 mb-2">
                                    <input
                                       ...
                                       placeholder="Enter price in millimes for {{ $product->name }}"
                                        value="{{ old('prices.' . $product->id) }}"
                                        {{ !(is_array(old('product_ids')) && in_array($product->id, old('product_ids'))) ? 'disabled' : '' }}>
                        ...
                        <div class="hstack gap-2 mt-4">
                            ...
                            <a href="{{ route('client.index') }}" class="btn btn-light">Discard</a>
                        </div>
                    </form>
